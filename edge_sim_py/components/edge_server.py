...
class EdgeServer(ComponentManager, Agent):
    ...
    def _to_dict(self) -> dict:
        ...
        dictionary = {
            "attributes": {
                ...
                "frequency_demand": self.frequency_demand,
    ...
    def collect(self) -> dict:
        ...
        metrics = {
            ...
            "Frequency Demand": self.frequency_demand,
    ...
    def has_capacity_to_host(self, service: object) -> bool:
        ...
        free_frequency = self.frequency - self.frequency_demand

        # Checking if the host would have resources to host the registry and its (additional) layers
        can_host = free_cpu >= service.cpu_demand and free_memory >= service.memory_demand and free_disk >= additional_disk_demand and free_frequency >= service.weight
        return can_host
